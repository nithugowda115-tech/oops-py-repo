...
reel1 = Instagram("dancing", "dancing with friends", "Nithya", "Bangalore")
reel1.liked()
reel1.liked()
...
reel2 = Instagram("finance minister conference", "finance minister conference with friends", "Aarav", "Delhi")
reel2.liked()
